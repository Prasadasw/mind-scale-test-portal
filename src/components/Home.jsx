  ...
  return (
    <div className={`min-h-screen transition-colors duration-300'}`}>
      ...
      <section className="relative">
          ...
          <div className="bg-white/90 backdrop-blur-sm mx-2 sm:mx-4 rounded-l-full rounded-r-full px-3 sm:px-6 py-2 sm:py-4 shadow-lg">
            <div className="flex items-center justify-between">
              ...
              <div className="text-white text-xl font-bold">
                <img src={logo} alt="logo" className="w-8 h-6 sm:w-12 sm:h-10" />
              </div>

              {/* Navigation - Hidden on mobile */}
              <nav className="hidden md:flex items-center space-x-4 lg:space-x-8">
                <a href="#" className="text-[#12316d] hover:text-blue-200 transition-colors duration-200 text-sm lg:text-base">Home</a>
                <a href="#" className="text-[#12316d] hover:text-blue-200 transition-colors duration-200 text-sm lg:text-base">About</a>
                <a href="#" className="text-[#12316d] hover:text-blue-200 transition-colors duration-200 text-sm lg:text-base">Feature</a>
                <a href="#" className="text-[#12316d] hover:text-blue-200 transition-colors duration-200 text-sm lg:text-base">Contact Us</a>
              </nav>
              ...
              >
                <img src={play} alt="download" className="w-4 h-4 sm:w-5 sm:h-5" />
        ...
        <div className="absolute top-1/2 left-4 sm:left-8 lg:left-16 transform -translate-y-1/2 z-10 max-w-[90%] sm:max-w-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-4 sm:mt-6">
            <button onClick={handleDownloadClick} className="hover:opacity-80 transition-opacity self-start">
              <img src={playstore} alt="Google Play Store" className="w-24 sm:w-28 md:w-32 h-auto object-contain cursor-pointer" />
            </button>
            <button onClick={handleDownloadClick} className="hover:opacity-80 transition-opacity self-start">
              <img src={appstore} alt="Apple App Store" className="w-24 sm:w-28 md:w-32 h-auto object-contain cursor-pointer" />
            </button>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 px-4 bg-gradient-to-br from-[#12316d] to-[#1a4a8f] text-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4 px-2">Join Thousands of Success Stories</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
            ...
            <div className="text-center">
              ...
              <div className="text-sm sm:text-base md:text-lg opacity-90">Success Stories</div>
            </div>
            <div className="text-center">
              <div className="text-3xl sm:text-4xl md:text-5xl font-bold mb-1 sm:mb-2">500+</div>
              <div className="text-sm sm:text-base md:text-lg opacity-90">Scholarships</div>
            </div>
            <div className="text-center">
              <div className="text-3xl sm:text-4xl md:text-5xl font-bold mb-1 sm:mb-2">98%</div>
              <div className="text-sm sm:text-base md:text-lg opacity-90">Success Rate</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#12316d] mb-3 sm:mb-4">Our Features</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="text-center">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-[#12316d] mb-3 sm:mb-4">Expert Guidance</h3>
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="text-center">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-[#12316d] mb-3 sm:mb-4">Scholarship Support</h3>
                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="text-center">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-[#12316d] mb-3 sm:mb-4">Success Tracking</h3>
                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                  Track your progress and achievements with our comprehensive monitoring and reporting system.
                </p>
              </div>
      ...
      <section className="py-12 sm:py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#12316d] mb-3 sm:mb-4">Why Choose Our App?</h2>
            <div className="w-20 h-1 bg-[#12316d] rounded-full mx-auto"></div>
            <p className="text-base sm:text-lg text-gray-600 mt-3 sm:mt-4 max-w-2xl mx-auto px-2">
              Discover the premium benefits that make us the #1 choice for defence aspirants
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            <div className="bg-gradient-to-br from-blue-50 to-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-blue-100">
              ...
              <h3 className="text-xl font-bold text-[#12316d] mb-3">Secure & Reliable</h3>
            ...
            <div className="bg-gradient-to-br from-green-50 to-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-green-100">
              ...
              <h3 className="text-xl font-bold text-[#12316d] mb-3">Lightning Fast</h3>
              <p className="text-gray-600">Experience blazing-fast performance with optimized algorithms.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-purple-100">
              ...
              <h3 className="text-xl font-bold text-[#12316d] mb-3">Premium Content</h3>
              <p className="text-gray-600">Access exclusive study materials and expert-curated resources.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-orange-100">
              ...
              <h3 className="text-xl font-bold text-[#12316d] mb-3">Expert Community</h3>
              <p className="text-gray-600">Connect with mentors and peers in our thriving community.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-red-50 to-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-red-100">
              ...
              <h3 className="text-xl font-bold text-[#12316d] mb-3">Real-time Analytics</h3>
              <p className="text-gray-600">Track your progress with detailed insights and analytics.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-yellow-50 to-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-yellow-100">
              ...
              <h3 className="text-xl font-bold text-[#12316d] mb-3">Cost Effective</h3>
              <p className="text-gray-600">Get premium features at an affordable price point.</p>
            </div>
          </div>
      ...
      <section className="py-12 sm:py-16 px-4 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#12316d] mb-3 sm:mb-4">How It Works</h2>
            <div className="w-20 h-1 bg-[#12316d] rounded-full mx-auto"></div>
            <p className="text-base sm:text-lg text-gray-600 mt-3 sm:mt-4 max-w-2xl mx-auto px-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-[#12316d] mb-3 sm:mb-4">Download the App</h3>
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed px-2">
                Get our app from Google Play Store or Apple App Store. It's free to download!
              </p>
            </div>
            ...
            <div className="text-center">
              <div className="relative inline-block mb-4 sm:mb-6">
                ...
                <div className="absolute -top-2 -right-2 w-7 h-7 sm:w-8 sm:h-8 bg-yellow-400 rounded-full flex items-center justify-center">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-yellow-900" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                  </svg>
                </div>
              </div>
              <h3 className="text-xl sm:text-2xl font-bold text-[#12316d] mb-3 sm:mb-4">Create Your Profile</h3>
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed px-2">
                Sign up and create your personalized profile. Tell us about your goals and aspirations.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-[#12316d] mb-3 sm:mb-4">Start Your Journey</h3>
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed px-2">
                Access premium features, get expert guidance, and start achieving your defence career goals!
              </p>
            </div>
          </div>
      ...
      <section className="py-12 sm:py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#12316d] mb-3 sm:mb-4">What Our Users Say</h2>
            <div className="w-20 h-1 bg-[#12316d] rounded-full mx-auto"></div>
            <p className="text-base sm:text-lg text-gray-600 mt-3 sm:mt-4">Real stories from real users</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="bg-gradient-to-br from-blue-50 to-white p-6 sm:p-8 rounded-2xl shadow-lg border border-blue-100">
              <div className="flex items-center mb-3 sm:mb-4">
                ...
                <div>
                  <h4 className="font-bold text-[#12316d] text-sm sm:text-base">Rajesh Kumar</h4>
                  <p className="text-xs sm:text-sm text-gray-600">NDA Aspirant</p>
                </div>
              </div>
              ...
              <p className="text-sm sm:text-base text-gray-700 italic">
                "This app changed my life! The expert guidance and study materials helped me clear my NDA exam. Highly recommended!"
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-white p-6 sm:p-8 rounded-2xl shadow-lg border border-green-100">
              <div className="flex items-center mb-3 sm:mb-4">
                ...
                <div>
                  <h4 className="font-bold text-[#12316d] text-sm sm:text-base">Priya Sharma</h4>
                  <p className="text-xs sm:text-sm text-gray-600">Scholarship Winner</p>
                </div>
              </div>
              <div className="flex mb-2 sm:mb-3">
                {[...Array(5)].map((_, i) => (
              ...
              <p className="text-sm sm:text-base text-gray-700 italic">
                "I found amazing scholarship opportunities through this app. The support team is incredible and always ready to help!"
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-white p-6 sm:p-8 rounded-2xl shadow-lg border border-purple-100">
              <div className="flex items-center mb-3 sm:mb-4">
                ...
                <div>
                  <h4 className="font-bold text-[#12316d] text-sm sm:text-base">Amit Mehta</h4>
                  <p className="text-xs sm:text-sm text-gray-600">Defence Officer</p>
                </div>
              </div>
              <div className="flex mb-2 sm:mb-3">
                {[...Array(5)].map((_, i) => (
              ...
              <p className="text-sm sm:text-base text-gray-700 italic">
                "The progress tracking feature is amazing! It helped me stay motivated and achieve my goals. Best investment I've made!"
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 bg-gradient-to-r from-[#12316d] via-[#1a4a8f] to-[#12316d] text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-base sm:text-lg md:text-xl mb-6 sm:mb-8 opacity-90 px-2">
            Join thousands of successful aspirants. Download now and unlock premium benefits!
          </p>
          ...
          <p className="text-xs sm:text-sm opacity-75 px-2">
            ✨ Limited Time: First 1000 users get premium access absolutely FREE!
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-center space-y-2 sm:space-y-0 sm:space-x-6">
              ...
              <div className="flex space-x-2 sm:space-x-3">
                <a href="#" className="w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center hover:opacity-70 transition-opacity">
            ...
            <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
              <button onClick={handleDownloadClick} className="hover:opacity-70 transition-opacity">
                <img src={appstore} alt="Download on the App Store" className="h-8 sm:h-10 w-auto cursor-pointer" />
              </button>
              <button onClick={handleDownloadClick} className="hover:opacity-70 transition-opacity">
                <img src={playstore} alt="GET IT ON Google Play" className="h-8 sm:h-10 w-auto cursor-pointer" />
              </button>
            </div>
          </div>
      ...
      {/* Download Popup */}
      <DownloadPopup isOpen={showDownloadPopup} onClose={() => setShowDownloadPopup(false)} />
    </div>
  )
}
